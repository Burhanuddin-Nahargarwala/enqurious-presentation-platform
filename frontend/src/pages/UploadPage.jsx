  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-secondary-900">Upload Presentation</h1>
          <p className="text-secondary-500 mt-1">Share your slides with the team</p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button
                ...
                disabled={!file || !formData.title || !formData.description || !formData.domain || uploading || success}
                isLoading={uploading}
              >
